...
-- Volcando datos para la tabla pwa_ecommerce.detallescarrito: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla pwa_ecommerce.detallesorden: ~14 rows (aproximadamente)
...
INSERT INTO `detallesorden` (`id`, `orden_id`, `variante_id`, `cantidad`, `subtotal`, `iva`) VALUES
	...
	(11, 5, 11, 3, 39.60, 5.40),
	(12, 6, 11, 1, 13.20, 1.80),
	(13, 7, 10, 1, 13.20, 1.80),
	(14, 8, 10, 1, 13.20, 1.80),
	(15, 9, 11, 1, 13.20, 1.80),
	(16, 9, 8, 2, 26.40, 3.60),
	(17, 10, 7, 1, 29.92, 4.08),
	(18, 10, 9, 1, 13.20, 1.80),
	(19, 11, 10, 1, 13.20, 1.80),
	(20, 12, 10, 1, 13.20, 1.80),
	(21, 13, 10, 1, 13.20, 1.80);
...
INSERT INTO `direccionesentrega` (`id`, `cliente_id`, `cedula`, `direccion`, `estado`, `parroquia_id`, `comentarios`, `Columna 8`, `postal`, `num_casa`) VALUES
	(1, 1, '0503341810', 'Latacunga', '1', '010101', 'comen', NULL, '050103', '23'),
	(2, 2, '0504353210', 'LATACUNGA AA', '1', '050104', 'COMENTARIO', NULL, NULL, NULL);
...
INSERT INTO `empresa` (`id`, `ruc`, `razon_social`, `direccion`, `obligado_contabilidad`, `regimen`, `logo`, `ambiente`, `establecimiento`, `punto_emision`, `secuencial`, `archivop12`, `usuario`, `clave`) VALUES
	(1, '1801971969001', 'YANCHAPANTA GOMEZ GRACIELA MAGDALENA DEL ROCIO', 'PICAIGUA, EL CALVARIO Y AV GALO VELA', 0, 'General', 'null', '1', '001', '002', '22', '/storage/firma/0503341810001.p12', '1801971969001', 'M@teoQ2%%7');
...
-- Volcando datos para la tabla pwa_ecommerce.estado_orden: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla pwa_ecommerce.facturas_electronicas: ~5 rows (aproximadamente)
...
INSERT INTO `facturas_electronicas` (`id`, `factura`, `estado`, `numero_autorizacion`, `clave_acceso`, `fecha`, `descargada`, `ordenes_id`) VALUES
	...
	(57, '001-002-000000017', 'AUTORIZADO', '3110202301180197196900110010020000000170000001713', '3110202301180197196900110010020000000170000001713', '31-10-2023', '1', 4),
	(58, '001-002-000000018', 'DEVUELTA', 'La fecha de emisión Wed Nov 22 00:00:00 GMT-05:00 2023 no consta como parte de la clave de acceso 2311202301180197196900110010020000000180000001818', '2311202301180197196900110010020000000180000001818', '23-11-2023', '0', 5),
	(59, '001-002-000000019', 'AUTORIZADO', '2211202301180197196900110010020000000190000001916', '2211202301180197196900110010020000000190000001916', '22-11-2023', '1', 8),
	(60, '001-002-000000020', 'AUTORIZADO', '2311202301180197196900110010020000000200000002017', '2311202301180197196900110010020000000200000002017', '23-11-2023', '1', 11),
	(61, '001-002-000000021', 'AUTORIZADO', '2611202301180197196900110010020000000210000002113', '2611202301180197196900110010020000000210000002113', '26-11-2023', '1', 13);
...
-- Volcando datos para la tabla pwa_ecommerce.ordenes: ~9 rows (aproximadamente)
DELETE FROM `ordenes`;
INSERT INTO `ordenes` (`id`, `cliente_id`, `fecha`, `estado`, `total`, `estado_orden_id`, `datosfacturacion_id`, `direccionesentrega_id`, `subtotal12`, `subtotaliva0`, `subtotal_sin_impuestos`, `descuento`, `iva`, `envio`) VALUES
	(3, 1, '2023-10-30 00:00:00', '1', 284.00, 5, 7, 1, 250.40, 0.00, 4.88, 0.00, 33.60, 5.00),
	(4, 1, '2023-10-31 00:00:00', '1', 88.00, 6, 7, 1, 78.57, 0.00, 4.46, 0.00, 9.44, 5.00),
	(5, 1, '2023-11-22 00:00:00', '1', 50.00, 6, 7, 1, 44.63, 0.00, 4.46, 0.00, 5.36, 5.00),
	(6, 1, '2023-11-23 00:00:00', '1', 20.00, 6, 7, 1, 17.85, 0.00, 4.46, 0.00, 2.15, 5.00),
	(7, 1, '2023-11-23 00:00:00', '1', 20.00, 6, 7, 1, 17.85, 0.00, 4.46, 0.00, 2.15, 5.00),
	(8, 1, '2023-11-22 00:00:00', '1', 20.00, 6, 7, 1, 17.85, 0.00, 4.46, 0.00, 2.15, 5.00),
	(9, 1, '2023-11-23 00:00:00', '1', 50.00, 6, 7, 1, 44.63, 0.00, 4.46, 0.00, 5.36, 5.00),
	(10, 1, '2023-11-23 00:00:00', '1', 54.00, 6, 7, 1, 48.21, 0.00, 4.46, 0.00, 5.79, 5.00),
	(11, 1, '2023-11-23 00:00:00', '1', 20.00, 5, 7, 1, 17.85, 0.00, 4.46, 0.00, 2.15, 5.00),
	(12, 1, '2023-11-26 01:01:19', '1', 20.00, 6, 7, 1, 17.85, 0.00, 4.46, 0.00, 2.15, 5.00),
	(13, 1, '2023-11-26 01:39:01', '1', 20.00, 5, 7, 1, 17.85, 0.00, 4.46, 0.00, 2.15, 5.00);
...
-- Volcando datos para la tabla pwa_ecommerce.productosdeseados: ~3 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `clave` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `rol_id`, `clave`) VALUES
	(1, 'Admin ', 'admin@gmail.com', NULL, '$2y$10$cvsKaLYriD5QUhXB7eoDu.3KdC8fo0pd0bXM4ypJdZ2SB6HUfGqBq', NULL, '2023-09-05 20:09:14', '2023-09-05 20:09:14', 1, '123456'),
	(4, 'Usuario', 'tanya.pesantez@gmail.com', '2023-09-07 17:49:06', '$2y$10$8ILe.IgdiV/LpawCznAP5e/w6x7kb3Mn.s8QPdp1gsjF7.aA0lWBi', NULL, '2023-09-07 17:49:11', '2023-11-26 05:10:11', 2, '123456'),
	(8, 'Cliente', 'cliente@gmail.com', NULL, '$2y$10$dUdDAr28CtSqJeesELV1a.veLCFSoeg6XBIrQnyg8OmMJoNu3suEe', NULL, '2023-09-19 05:32:20', '2023-09-19 05:54:52', 2, '123456');
